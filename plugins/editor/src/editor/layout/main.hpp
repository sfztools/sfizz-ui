...
auto* const view__76 = createLabel(CRect(10, 145, 155, 170), -1, "MPE master bend (st)", kLeftText, 14);
view__48->addView(view__76);
auto* const view__77 = createValueMenu(CRect(180, 145, 260, 170), kTagSetMPEMasterPitchBendRange, "", kCenterText, 14);
mpeMasterPitchBendRangeSlider_ = view__77;
view__48->addView(view__77);
auto* const view__78 = createLabel(CRect(270, 145, 415, 170), -1, "MPE per-note bend (st)", kLeftText, 14);
view__48->addView(view__78);
auto* const view__79 = createValueMenu(CRect(430, 145, 510, 170), kTagSetMPEPerNotePitchBendRange, "", kCenterText, 14);
mpePerNotePitchBendRangeSlider_ = view__79;
view__48->addView(view__79);
auto* const view__80 = createLabel(CRect(270, 5, 380, 30), -1, "Rendering quality", kLeftText, 14);
view__48->addView(view__80);
auto* const view__81 = createHLine(CRect(10, 25, 250, 30), -1, "", kCenterText, 14);
view__48->addView(view__81);
auto* const view__82 = createLabel(CRect(10, 5, 105, 30), -1, "Engine options", kLeftText, 14);
view__48->addView(view__82);
auto* const view__83 = createLabel(CRect(525, 5, 565, 30), -1, "Other", kLeftText, 14);
view__48->addView(view__83);
auto* const view__84 = createLabel(CRect(525, 145, 750, 170), -1, "Tuning", kLeftText, 14);
view__48->addView(view__84);
auto* const view__85 = createHLine(CRect(270, 25, 509, 30), -1, "", kCenterText, 14);
view__48->addView(view__85);
auto* const view__86 = createHLine(CRect(525, 25, 765, 30), -1, "", kCenterText, 14);
view__48->addView(view__86);
auto* const view__87 = createHLine(CRect(525, 165, 750, 170), -1, "", kCenterText, 14);
view__48->addView(view__87);
auto* const view__88 = createChevronValueDropDown(CRect(725, 225, 750, 250), kTagSetTuningFrequency, "", kCenterText, 24);
tuningFrequencyDropdown_ = view__88;
view__48->addView(view__88);
auto* const view__89 = createTextEdit(CRect(665, 225, 725, 250), kTagSetTuningFrequency, "", kCenterText, 14);
tuningFrequencyEdit_ = view__89;
view__48->addView(view__89);
auto* const view__90 = createLabel(CRect(270, 110, 415, 135), -1, "when freewheeling", kLeftText, 14);
view__48->addView(view__90);
auto* const view__91 = createValueMenu(CRect(430, 110, 510, 135), kTagSetFreewheelingOscillatorQuality, "", kCenterText, 14);
freewheelingOscillatorQualitySlider_ = view__91;
view__48->addView(view__91);
auto* const view__92 = createLabel(CRect(525, 85, 620, 110), -1, "Zoom", kLeftText, 14);
view__48->addView(view__92);
auto* const view__93 = createOptionMenu(CRect(665, 85, 765, 110), kTagZoomMenu, "", kCenterText, 14);
zoomMenu_ = view__93;
view__48->addView(view__93);
auto* const view__94 = createValueButton(CRect(665, 110, 765, 135), kTagSetDefaultZoom, "Set Default", kCenterText, 14);
defaultZoomButton_ = view__94;
view__48->addView(view__94);
auto* const view__95 = createPiano(CRect(0, 445, 775, 515), -1, "", kCenterText, 16);
piano_ = view__95;
view__0->addView(view__95);
auto* const view__96 = createLogicalGroup(CRect(0, 110, 775, 445), -1, "", kCenterText, 14);
subPanels_[kPanelGeneral] = view__96;
view__0->addView(view__96);
view__96->setVisible(false);
enterPalette(invertedPalette);
auto* const view__97 = createHoverBox(CRect(5, 105, 175, 130), -1, "", kCenterText, 14);
lblHover_ = view__97;
view__0->addView(view__97);
view__97->setVisible(false);
enterPalette(defaultPalette);
