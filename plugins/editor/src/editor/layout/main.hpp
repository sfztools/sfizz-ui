...
auto* const view__79 = createValueMenu(CRect(180, 175, 250, 200), kTagSetMPEMasterPitchBendRange, "", kCenterText, 14);
...
auto* const view__83 = createValueMenu(CRect(180, 235, 250, 260), kTagSetMPEPerNotePitchBendRange, "", kCenterText, 14);
