...
auto* const view__78 = createLabel(CRect(10, 175, 155, 200), -1, "MPE per-note bend (st)", kLeftText, 14);
view__48->addView(view__78);
auto* const view__79 = createValueMenu(CRect(180, 175, 260, 200), kTagSetMPEPerNotePitchBendRange, "", kCenterText, 14);
