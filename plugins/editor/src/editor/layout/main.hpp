...
auto* const view__74 = createLabel(CRect(10, 110, 155, 135), -1, "MPE enabled", kLeftText, 14);
view__48->addView(view__74);
auto* const view__75 = createCheckbox(CRect(180, 110, 205, 135), kTagSetMPEEnabled, "", kCenterText, 14);
mpeEnabledCheckbox_ = view__75;
view__48->addView(view__75);
auto* const view__76 = createLabel(CRect(10, 138, 155, 163), -1, "Ignore MCM on/off", kLeftText, 14);
view__48->addView(view__76);
auto* const view__77 = createCheckbox(CRect(180, 138, 205, 163), kTagSetMPEIgnoreMcm, "", kCenterText, 14);
mpeIgnoreMcmCheckbox_ = view__77;
view__48->addView(view__77);
auto* const view__78 = createLabel(CRect(10, 166, 155, 191), -1, "Ignore master bend", kLeftText, 14);
view__48->addView(view__78);
auto* const view__79 = createCheckbox(CRect(180, 166, 205, 191), kTagSetMPEMasterBendIgnoreRpn, "", kCenterText, 14);
mpeMasterBendIgnoreRpnCheckbox_ = view__79;
view__48->addView(view__79);
auto* const view__80 = createLabel(CRect(10, 194, 155, 219), -1, "Current master bend", kLeftText, 14);
view__48->addView(view__80);
auto* const view__81 = createStrikethroughLabel(CRect(180, 194, 250, 219), -1, "", kCenterText, 14);
mpeMasterEffectiveBendDisplay_ = view__81;
view__48->addView(view__81);
auto* const view__82 = createLabel(CRect(10, 222, 155, 247), -1, "MPE master bend (st)", kLeftText, 14);
view__48->addView(view__82);
auto* const view__83 = createValueMenu(CRect(180, 222, 250, 247), kTagSetMPEMasterPitchBendRange, "", kCenterText, 14);
mpeMasterPitchBendRangeSlider_ = view__83;
view__48->addView(view__83);
auto* const view__84 = createLabel(CRect(10, 250, 155, 275), -1, "Ignore per-note bend", kLeftText, 14);
view__48->addView(view__84);
auto* const view__85 = createCheckbox(CRect(180, 250, 205, 275), kTagSetMPEPerNoteBendIgnoreRpn, "", kCenterText, 14);
mpePerNoteBendIgnoreRpnCheckbox_ = view__85;
view__48->addView(view__85);
auto* const view__86 = createLabel(CRect(10, 278, 155, 303), -1, "Current per-note bend", kLeftText, 14);
view__48->addView(view__86);
auto* const view__87 = createStrikethroughLabel(CRect(180, 278, 250, 303), -1, "", kCenterText, 14);
mpePerNoteEffectiveBendDisplay_ = view__87;
view__48->addView(view__87);
auto* const view__88 = createLabel(CRect(10, 306, 155, 331), -1, "MPE per-note bend (st)", kLeftText, 14);
view__48->addView(view__88);
auto* const view__89 = createValueMenu(CRect(180, 306, 250, 331), kTagSetMPEPerNotePitchBendRange, "", kCenterText, 14);
mpePerNotePitchBendRangeSlider_ = view__89;
view__48->addView(view__89);
auto* const view__90 = createLabel(CRect(270, 5, 380, 30), -1, "Rendering quality", kLeftText, 14);
view__48->addView(view__90);
auto* const view__91 = createHLine(CRect(10, 25, 250, 30), -1, "", kCenterText, 14);
view__48->addView(view__91);
auto* const view__92 = createLabel(CRect(10, 5, 105, 30), -1, "Engine options", kLeftText, 14);
view__48->addView(view__92);
auto* const view__93 = createLabel(CRect(525, 5, 565, 30), -1, "Other", kLeftText, 14);
view__48->addView(view__93);
auto* const view__94 = createLabel(CRect(525, 145, 750, 170), -1, "Tuning", kLeftText, 14);
view__48->addView(view__94);
auto* const view__95 = createHLine(CRect(270, 25, 509, 30), -1, "", kCenterText, 14);
view__48->addView(view__95);
auto* const view__96 = createHLine(CRect(525, 25, 765, 30), -1, "", kCenterText, 14);
view__48->addView(view__96);
auto* const view__97 = createHLine(CRect(525, 165, 750, 170), -1, "", kCenterText, 14);
view__48->addView(view__97);
auto* const view__98 = createChevronValueDropDown(CRect(725, 225, 750, 250), kTagSetTuningFrequency, "", kCenterText, 24);
tuningFrequencyDropdown_ = view__98;
view__48->addView(view__98);
auto* const view__99 = createTextEdit(CRect(665, 225, 725, 250), kTagSetTuningFrequency, "", kCenterText, 14);
tuningFrequencyEdit_ = view__99;
view__48->addView(view__99);
auto* const view__100 = createLabel(CRect(270, 110, 415, 135), -1, "when freewheeling", kLeftText, 14);
view__48->addView(view__100);
auto* const view__101 = createValueMenu(CRect(430, 110, 510, 135), kTagSetFreewheelingOscillatorQuality, "", kCenterText, 14);
freewheelingOscillatorQualitySlider_ = view__101;
view__48->addView(view__101);
auto* const view__102 = createLabel(CRect(525, 85, 620, 110), -1, "Zoom", kLeftText, 14);
view__48->addView(view__102);
auto* const view__103 = createOptionMenu(CRect(665, 85, 765, 110), kTagZoomMenu, "", kCenterText, 14);
zoomMenu_ = view__103;
view__48->addView(view__103);
auto* const view__104 = createValueButton(CRect(665, 110, 765, 135), kTagSetDefaultZoom, "Set Default", kCenterText, 14);
defaultZoomButton_ = view__104;
view__48->addView(view__104);
auto* const view__105 = createPiano(CRect(0, 445, 775, 515), -1, "", kCenterText, 16);
piano_ = view__105;
view__0->addView(view__105);
auto* const view__106 = createLogicalGroup(CRect(0, 110, 775, 445), -1, "", kCenterText, 14);
subPanels_[kPanelGeneral] = view__106;
view__0->addView(view__106);
view__106->setVisible(false);
enterPalette(invertedPalette);
auto* const view__107 = createHoverBox(CRect(5, 105, 175, 130), -1, "", kCenterText, 14);
lblHover_ = view__107;
view__0->addView(view__107);
view__107->setVisible(false);
enterPalette(defaultPalette);
