...
auto* const view__74 = createLabel(CRect(10, 115, 155, 140), -1, "MPE enabled", kLeftText, 14);
view__48->addView(view__74);
auto* const view__75 = createCheckbox(CRect(180, 115, 205, 140), kTagSetMPEEnabled, "", kCenterText, 14);
mpeEnabledCheckbox_ = view__75;
view__48->addView(view__75);
auto* const view__76 = createLabel(CRect(10, 145, 155, 170), -1, "Ignore master bend", kLeftText, 14);
view__48->addView(view__76);
auto* const view__77 = createCheckbox(CRect(180, 145, 205, 170), kTagSetMPEMasterBendIgnoreRpn, "", kCenterText, 14);
mpeMasterBendIgnoreRpnCheckbox_ = view__77;
view__48->addView(view__77);
auto* const view__78 = createLabel(CRect(10, 175, 155, 200), -1, "Current master bend", kLeftText, 14);
view__48->addView(view__78);
auto* const view__79 = createStrikethroughLabel(CRect(180, 175, 250, 200), -1, "", kCenterText, 14);
mpeMasterEffectiveBendDisplay_ = view__79;
view__48->addView(view__79);
auto* const view__80 = createLabel(CRect(10, 205, 155, 230), -1, "MPE master bend (st)", kLeftText, 14);
view__48->addView(view__80);
auto* const view__81 = createValueMenu(CRect(180, 205, 250, 230), kTagSetMPEMasterPitchBendRange, "", kCenterText, 14);
mpeMasterPitchBendRangeSlider_ = view__81;
view__48->addView(view__81);
auto* const view__82 = createLabel(CRect(10, 235, 155, 260), -1, "Ignore per-note bend", kLeftText, 14);
view__48->addView(view__82);
auto* const view__83 = createCheckbox(CRect(180, 235, 205, 260), kTagSetMPEPerNoteBendIgnoreRpn, "", kCenterText, 14);
mpePerNoteBendIgnoreRpnCheckbox_ = view__83;
view__48->addView(view__83);
auto* const view__84 = createLabel(CRect(10, 265, 155, 290), -1, "Current per-note bend", kLeftText, 14);
view__48->addView(view__84);
auto* const view__85 = createStrikethroughLabel(CRect(180, 265, 250, 290), -1, "", kCenterText, 14);
mpePerNoteEffectiveBendDisplay_ = view__85;
view__48->addView(view__85);
auto* const view__86 = createLabel(CRect(10, 295, 155, 320), -1, "MPE per-note bend (st)", kLeftText, 14);
view__48->addView(view__86);
auto* const view__87 = createValueMenu(CRect(180, 295, 250, 320), kTagSetMPEPerNotePitchBendRange, "", kCenterText, 14);
mpePerNotePitchBendRangeSlider_ = view__87;
view__48->addView(view__87);
auto* const view__88 = createLabel(CRect(270, 5, 380, 30), -1, "Rendering quality", kLeftText, 14);
view__48->addView(view__88);
auto* const view__89 = createHLine(CRect(10, 25, 250, 30), -1, "", kCenterText, 14);
view__48->addView(view__89);
auto* const view__90 = createLabel(CRect(10, 5, 105, 30), -1, "Engine options", kLeftText, 14);
view__48->addView(view__90);
auto* const view__91 = createLabel(CRect(525, 5, 565, 30), -1, "Other", kLeftText, 14);
view__48->addView(view__91);
auto* const view__92 = createLabel(CRect(525, 145, 750, 170), -1, "Tuning", kLeftText, 14);
view__48->addView(view__92);
auto* const view__93 = createHLine(CRect(270, 25, 509, 30), -1, "", kCenterText, 14);
view__48->addView(view__93);
auto* const view__94 = createHLine(CRect(525, 25, 765, 30), -1, "", kCenterText, 14);
view__48->addView(view__94);
auto* const view__95 = createHLine(CRect(525, 165, 750, 170), -1, "", kCenterText, 14);
view__48->addView(view__95);
auto* const view__96 = createChevronValueDropDown(CRect(725, 225, 750, 250), kTagSetTuningFrequency, "", kCenterText, 24);
tuningFrequencyDropdown_ = view__96;
view__48->addView(view__96);
auto* const view__97 = createTextEdit(CRect(665, 225, 725, 250), kTagSetTuningFrequency, "", kCenterText, 14);
tuningFrequencyEdit_ = view__97;
view__48->addView(view__97);
auto* const view__98 = createLabel(CRect(270, 110, 415, 135), -1, "when freewheeling", kLeftText, 14);
view__48->addView(view__98);
auto* const view__99 = createValueMenu(CRect(430, 110, 510, 135), kTagSetFreewheelingOscillatorQuality, "", kCenterText, 14);
freewheelingOscillatorQualitySlider_ = view__99;
view__48->addView(view__99);
auto* const view__100 = createLabel(CRect(525, 85, 620, 110), -1, "Zoom", kLeftText, 14);
view__48->addView(view__100);
auto* const view__101 = createOptionMenu(CRect(665, 85, 765, 110), kTagZoomMenu, "", kCenterText, 14);
zoomMenu_ = view__101;
view__48->addView(view__101);
auto* const view__102 = createValueButton(CRect(665, 110, 765, 135), kTagSetDefaultZoom, "Set Default", kCenterText, 14);
defaultZoomButton_ = view__102;
view__48->addView(view__102);
auto* const view__103 = createPiano(CRect(0, 445, 775, 515), -1, "", kCenterText, 16);
piano_ = view__103;
view__0->addView(view__103);
auto* const view__104 = createLogicalGroup(CRect(0, 110, 775, 445), -1, "", kCenterText, 14);
subPanels_[kPanelGeneral] = view__104;
view__0->addView(view__104);
view__104->setVisible(false);
enterPalette(invertedPalette);
auto* const view__105 = createHoverBox(CRect(5, 105, 175, 130), -1, "", kCenterText, 14);
lblHover_ = view__105;
view__0->addView(view__105);
view__105->setVisible(false);
enterPalette(defaultPalette);
