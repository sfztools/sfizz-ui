...
enum
{
    ...
    SFIZZ_MPE_ENABLED = 23,
    SFIZZ_MPE_MASTER_PITCH_BEND_RANGE = 24,
    SFIZZ_MPE_PER_NOTE_PITCH_BEND_RANGE = 25,
};
...
enum
{
    ...
    SFIZZ_MULTI_MPE_ENABLED = 37,
    SFIZZ_MULTI_MPE_MASTER_PITCH_BEND_RANGE = 38,
    SFIZZ_MULTI_MPE_PER_NOTE_PITCH_BEND_RANGE = 39,
};
